...
public:
    ...
    {
        return GetType() == Stat_Empty;
    }
    bool IsExpression(void) const
    {
        return GetType() == Stat_Expression;
    }
    bool IsBlock(void) const
    {
        return GetType() == Stat_Block;
    }
...
public:
    explicit LocalVarInitStatement(
        const std::string & name, int stackAddress, int startAddress, int endAddress,
        ExpressionPtr init = ExpressionPtr())
    {
        m_Name = name;
    ...
    int GetStackAddress(void) const
    {
        return m_StackAddress;
    }
    int GetStartAddress(void) const
    {
        return m_StartAddress;
    }
    int GetEndAddress(void) const
    {
        return m_EndAddress;
    }
};
...
public:
    ...
    int GetLoopStartAddress(void) const
    {
        return m_LoopStartAddress;
    }
    int GetLoopEndAddress(void) const
    {
        return m_LoopEndAddress;
    }
};
...
public:
    explicit ForStatement(
        StatementPtr initialization, ExpressionPtr condition, StatementPtr incrementation, StatementPtr block)
    {
